...
- Control de actuadores y motores
- Arquitecturas de software para robots

### 2. [Electrónica](electronica.md)
Fundamentos de electrónica aplicada a robótica:
- Componentes electrónicos básicos
- Circuitos de potencia
- Sensores y actuadores
- Comunicación entre dispositivos

### 3. [Mecánica](mecanica.md)
...
### 5. [Bibliografía](bibliografia.md)
Referencias y recursos académicos (en desarrollo)
...
- **[04_Planificacion_Control](../04_Planificacion_Control/)**: Implementación de controladores
...
3. Actualizar con nuevos aprendizajes durante el proyecto
